"""autogenerated by genpy from parbot_pathplanning/CostMapStamped.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import parbot_pathplanning.msg
import geometry_msgs.msg
import std_msgs.msg

class CostMapStamped(genpy.Message):
  _md5sum = "8e0ea9cbbb465ffdf093822f72b775f6"
  _type = "parbot_pathplanning/CostMapStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','int64','int64','int64','int64','parbot_pathplanning/CostPointStamped[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = parbot_pathplanning.msg.CostPointStamped()
        _v7 = val1.header
        start = end
        end += 4
