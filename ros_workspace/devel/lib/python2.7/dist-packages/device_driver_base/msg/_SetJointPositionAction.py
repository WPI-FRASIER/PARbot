"""autogenerated by genpy from device_driver_base/SetJointPositionAction.msg. Do not edit."""
import sys
...
class SetJointPositionAction(genpy.Message):
  _md5sum = "ce558c733911bfb7d65aefaa7e74b485"
  _type = "device_driver_base/SetJointPositionAction"
...
"""
  ...
  _slot_types = ['device_driver_base/SetJointPositionActionGoal','device_driver_base/SetJointPositionActionResult','device_driver_base/SetJointPositionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetJointPositionAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = device_driver_base.msg.SetJointPositionActionGoal()
      if self.action_result is None:
        self.action_result = device_driver_base.msg.SetJointPositionActionResult()
      if self.action_feedback is None:
        self.action_feedback = device_driver_base.msg.SetJointPositionActionFeedback()
    else:
      self.action_goal = device_driver_base.msg.SetJointPositionActionGoal()
      self.action_result = device_driver_base.msg.SetJointPositionActionResult()
      self.action_feedback = device_driver_base.msg.SetJointPositionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d3I.pack(_x.action_goal.goal.angle, _x.action_goal.goal.max_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.final_angle, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_d.pack(self.action_feedback.feedback.current_angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.angle, _x.action_goal.goal.max_velocity, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.final_angle, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.current_angle,) = _struct_d.unpack(str[start:end])
      return self
