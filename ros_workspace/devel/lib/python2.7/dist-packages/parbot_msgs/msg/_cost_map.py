"""autogenerated by genpy from parbot_msgs/cost_map.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['float64','int64','int64','int64','int64','parbot_msgs/cost_point[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = parbot_msgs.msg.cost_point()
        _v2 = val1.point
        _x = _v2
        start = end
        end += 16
