"""autogenerated by genpy from parbot_motion_planning/cost_map_2.msg. Do not edit."""
import sys
...
class cost_map_2(genpy.Message):
  ...
  _type = "parbot_motion_planning/cost_map_2"
...
"""
  ...
  _slot_types = ['float64','int64','int64','int64','int64','parbot_motion_planning/Column[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = parbot_motion_planning.msg.Column()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
