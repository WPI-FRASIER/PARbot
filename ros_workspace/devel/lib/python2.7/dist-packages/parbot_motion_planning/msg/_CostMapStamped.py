"""autogenerated by genpy from parbot_motion_planning/CostMapStamped.msg. Do not edit."""
import sys
...
class CostMapStamped(genpy.Message):
  ...
  _type = "parbot_motion_planning/CostMapStamped"
...
"""
  ...
  _slot_types = ['std_msgs/Header','float64','int64','int64','int64','int64','parbot_motion_planning/CostPointStamped[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = parbot_motion_planning.msg.CostPointStamped()
        _v7 = val1.header
        start = end
        end += 4
