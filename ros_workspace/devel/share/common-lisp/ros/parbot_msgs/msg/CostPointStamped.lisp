...
(cl:defmethod cl:initialize-instance :after ((m <CostPointStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CostPointStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_msgs-msg:<CostPointStamped> is deprecated: use parbot_msgs-msg:CostPointStamped instead.")))
