...
(cl:defmethod cl:initialize-instance :after ((m <Column>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Column)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_msgs-msg:<Column> is deprecated: use parbot_msgs-msg:Column instead.")))

(cl:ensure-generic-function 'row-val :lambda-list '(m))
(cl:defmethod row-val ((m <Column>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_msgs-msg:row-val is deprecated.  Use parbot_msgs-msg:row instead.")
  (row m))
