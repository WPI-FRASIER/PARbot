...
(cl:defclass <cost_map> (roslisp-msg-protocol:ros-message)
  ((grid_size
   ...
   (grid
    :reader grid
    :initarg :grid
    :type (cl:vector parbot_msgs-msg:cost_point)
   :initform (cl:make-array 0 :element-type 'parbot_msgs-msg:cost_point :initial-element (cl:make-instance 'parbot_msgs-msg:cost_point))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <cost_map>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cost_map)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_msgs-msg:<cost_map> is deprecated: use parbot_msgs-msg:cost_map instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cost_map>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grid)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'parbot_msgs-msg:cost_point))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cost_map>)))
  ...
  (cl:format cl:nil "float64 grid_size~%int64 row_length~%int64 num_rows~%int64 x_offset~%int64 y_offset~%cost_point[] grid~%~%================================================================================~%MSG: parbot_msgs/cost_point~%cart_point point~%float64 cost~%~%================================================================================~%MSG: parbot_msgs/cart_point~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cost_map)))
  "Returns full string definition for message of type 'cost_map"
  (cl:format cl:nil "float64 grid_size~%int64 row_length~%int64 num_rows~%int64 x_offset~%int64 y_offset~%cost_point[] grid~%~%================================================================================~%MSG: parbot_msgs/cost_point~%cart_point point~%float64 cost~%~%================================================================================~%MSG: parbot_msgs/cart_point~%float64 x~%float64 y~%~%~%"))
