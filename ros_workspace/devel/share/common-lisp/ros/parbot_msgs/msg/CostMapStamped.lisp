...
(cl:defclass <CostMapStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grid
    :reader grid
    :initarg :grid
    :type (cl:vector parbot_msgs-msg:CostPointStamped)
   :initform (cl:make-array 0 :element-type 'parbot_msgs-msg:CostPointStamped :initial-element (cl:make-instance 'parbot_msgs-msg:CostPointStamped))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CostMapStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CostMapStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_msgs-msg:<CostMapStamped> is deprecated: use parbot_msgs-msg:CostMapStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CostMapStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_msgs-msg:header-val is deprecated.  Use parbot_msgs-msg:header instead.")
  (header m))
...
(cl:defmethod grid-val ((m <CostMapStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_msgs-msg:grid-val is deprecated.  Use parbot_msgs-msg:grid instead.")
  (grid m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CostMapStamped>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grid)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'parbot_msgs-msg:CostPointStamped))
