...
(cl:defmethod cl:initialize-instance :after ((m <CostPointStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CostPointStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_pathplanning-msg:<CostPointStamped> is deprecated: use parbot_pathplanning-msg:CostPointStamped instead.")))
...
(cl:defmethod point-val ((m <CostPointStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_pathplanning-msg:point-val is deprecated.  Use parbot_pathplanning-msg:point instead.")
  (point m))

(cl:ensure-generic-function 'cost-val :lambda-list '(m))
(cl:defmethod cost-val ((m <CostPointStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_pathplanning-msg:cost-val is deprecated.  Use parbot_pathplanning-msg:cost instead.")
  (cost m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CostPointStamped>)))
  ...
  "parbot_pathplanning/CostPointStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CostPointStamped)))
  "Returns string type for a message object of type 'CostPointStamped"
  "parbot_pathplanning/CostPointStamped")
