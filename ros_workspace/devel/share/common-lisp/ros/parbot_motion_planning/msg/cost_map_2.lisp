...
(cl:defclass <cost_map_2> (roslisp-msg-protocol:ros-message)
  ((grid_size
   ...
   (column
    :reader column
    :initarg :column
    :type (cl:vector parbot_motion_planning-msg:Column)
   :initform (cl:make-array 0 :element-type 'parbot_motion_planning-msg:Column :initial-element (cl:make-instance 'parbot_motion_planning-msg:Column))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <cost_map_2>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cost_map_2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_motion_planning-msg:<cost_map_2> is deprecated: use parbot_motion_planning-msg:cost_map_2 instead.")))
...
(cl:defmethod column-val ((m <cost_map_2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_motion_planning-msg:column-val is deprecated.  Use parbot_motion_planning-msg:column instead.")
  (column m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <cost_map_2>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'column)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'parbot_motion_planning-msg:Column))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cost_map_2>)))
  ...
  "parbot_motion_planning/cost_map_2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cost_map_2)))
  "Returns string type for a message object of type 'cost_map_2"
  "parbot_motion_planning/cost_map_2")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cost_map_2>)))
  ...
  (cl:format cl:nil "float64 grid_size~%int64 row_length~%int64 num_rows~%int64 x_offset~%int64 y_offset~%Column[] column~%~%================================================================================~%MSG: parbot_motion_planning/Column~%float64[] row~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cost_map_2)))
  "Returns full string definition for message of type 'cost_map_2"
  (cl:format cl:nil "float64 grid_size~%int64 row_length~%int64 num_rows~%int64 x_offset~%int64 y_offset~%Column[] column~%~%================================================================================~%MSG: parbot_motion_planning/Column~%float64[] row~%~%~%"))
