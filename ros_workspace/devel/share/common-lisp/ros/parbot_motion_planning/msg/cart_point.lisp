...
(cl:defmethod cl:initialize-instance :after ((m <cart_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cart_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_motion_planning-msg:<cart_point> is deprecated: use parbot_motion_planning-msg:cart_point instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <cart_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_motion_planning-msg:x-val is deprecated.  Use parbot_motion_planning-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <cart_point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parbot_motion_planning-msg:y-val is deprecated.  Use parbot_motion_planning-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cart_point>)))
  ...
  "parbot_motion_planning/cart_point")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cart_point)))
  "Returns string type for a message object of type 'cart_point"
  "parbot_motion_planning/cart_point")
