...
(cl:defclass <cost_point> (roslisp-msg-protocol:ros-message)
  ((point
    :reader point
    :initarg :point
    :type parbot_motion_planning-msg:cart_point
    :initform (cl:make-instance 'parbot_motion_planning-msg:cart_point))
   (cost
    :reader cost
    :initarg :cost
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <cost_point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'cost_point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_motion_planning-msg:<cost_point> is deprecated: use parbot_motion_planning-msg:cost_point instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<cost_point>)))
  ...
  "parbot_motion_planning/cost_point")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'cost_point)))
  "Returns string type for a message object of type 'cost_point"
  "parbot_motion_planning/cost_point")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<cost_point>)))
  ...
  (cl:format cl:nil "cart_point point~%float64 cost~%~%================================================================================~%MSG: parbot_motion_planning/cart_point~%float64 x~%float64 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'cost_point)))
  "Returns full string definition for message of type 'cost_point"
  (cl:format cl:nil "cart_point point~%float64 cost~%~%================================================================================~%MSG: parbot_motion_planning/cart_point~%float64 x~%float64 y~%~%~%"))
