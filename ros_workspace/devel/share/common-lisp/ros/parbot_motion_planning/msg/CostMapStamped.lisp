...
(cl:defclass <CostMapStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (grid
    :reader grid
    :initarg :grid
    :type (cl:vector parbot_motion_planning-msg:CostPointStamped)
   :initform (cl:make-array 0 :element-type 'parbot_motion_planning-msg:CostPointStamped :initial-element (cl:make-instance 'parbot_motion_planning-msg:CostPointStamped))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <CostMapStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CostMapStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parbot_motion_planning-msg:<CostMapStamped> is deprecated: use parbot_motion_planning-msg:CostMapStamped instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CostMapStamped>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'grid)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'parbot_motion_planning-msg:CostPointStamped))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CostMapStamped>)))
  ...
  "parbot_motion_planning/CostMapStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CostMapStamped)))
  "Returns string type for a message object of type 'CostMapStamped"
  "parbot_motion_planning/CostMapStamped")
