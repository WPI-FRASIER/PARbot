...
if(NOT "/home/parbot/ros_workspace/src/river_util/river_ros_util/include" STREQUAL "")
  set(river_ros_util_INCLUDE_DIRS "")
  set(_include_dirs "/home/parbot/ros_workspace/src/river_util/river_ros_util/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'river_ros_util' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/parbot/ros_workspace/src/river_util/river_ros_util/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
